...
if (isset($_POST['update'])) {
    ...
    if ($temp_name1=='' AND $temp_name2=='' AND $temp_name3=='') {
        ...
        product_keywords='$product_keywords',product_description='$product_desc',product_price='$product_price', product_label='$product_label', product_sale='$product_sale', Rate='$product_rate' where product_id='$p_id'";
