<?php
    ...
    {
        $average = 0;
        $avgQuery = "SELECT ratingnumber FROM ratestart WHERE id_cus = '" . $userId . "' and product_id = '" . $productId . "'";
        $total_row = 0;
        ...
        if ($total_row > 0) {
            foreach ($result as $row) {
                $average = round($row["ratingnumber"]);
            } // endForeach
        } // endIf
        return $average;
    }
    ...
    {
        $totalVotesQuery = "SELECT * FROM ratestart WHERE product_id = '" . $productId . "'";
    ...
    function add_cart() {
        ...
        if (isset($_GET['add_cart'])) {
            ...
            if ($count_check>0) {
                ...
                $query = "insert into cart (product_id, ip_add, p_price) values ('$product_id', '$ip_add', '$product_price')";
